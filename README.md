...
The neural network model includes 37 neurons, 4 hidden layers, and 3 activation functions (relu, tanh, sigmoid). The screenshot shows the details of the models.
